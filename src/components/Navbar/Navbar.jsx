...
const Navbar = () => {
    ...
    <li><Link to="/shop-page" className="text-xl block after:block bg-none after:h-[3px] after:bg-blue-400 after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center">Shop</Link></li>
