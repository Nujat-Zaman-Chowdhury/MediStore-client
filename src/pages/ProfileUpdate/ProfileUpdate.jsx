...
<div
    ...
    <div className="p-4 border-t mx-8 mt-2">
        <button onClick={()=>setIsOpen(true)} className="block mx-auto rounded-full bg-blue-400 hover:shadow-lg font-semibold text-white px-6 py-2">Update Profile</button>
        <ProfileModal isOpen={isOpen} closeModal={closeModal} handleSubmit={handleSubmit} onImageChange={onImageChange}
        image={image}></ProfileModal>
    </div>
</div>
    );
};
